      ...
      <section class="store-cart">
        <div class="container">
                      ...
                      <td style="">
                        <div
                          ...
                          style="
                            ...
                            background-image: url('{{ Storage::url($cart->product->galleries->first()->photos) }}');
                            @else
          ...
          <form action="{{ route('checkout') }}" id="locations" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-2" data-aos="fade-out" data-aos-delay="200">
              <div class="col-md-6">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control" id="regencies_id" name="regencies_id" v-if="regencies" v-model="regencies_id">
