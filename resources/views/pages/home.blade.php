    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @forelse ($categories as $category)
                ...
                data-aos="fade-up"
                data-aos-delay="{{ $incCategory += 100 }}"
                >
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div
                ...
                <div class="products-price">$94,232</div>
                </a>
            </div>
            <div
                class="col-6 col-md-4 col-lg-3"
                ...
                <div class="products-price">$1,472</div>
                </a>
            </div>
            <div
                class="col-6 col-md-4 col-lg-3"
                ...
                <div class="products-price">$256</div>
                </a>
            </div>
            <div
                class="col-6 col-md-4 col-lg-3"
                ...
                <div class="products-price">$43</div>
                </a>
            </div>
            <div
                class="col-6 col-md-4 col-lg-3"
                ...
                <div class="products-price">$1,289</div>
                </a>
            </div>
            <div
                class="col-6 col-md-4 col-lg-3"
                ...
                <div class="products-price">$70,382</div>
                </a>
            </div>
            <div
                class="col-6 col-md-4 col-lg-3"
                ...
                <div class="products-price">$98</div>
                </a>
            </div> --}}
        </div>
    </div>
